...
| Other developer tools | npm CLI packages through `npm:<package>`, public GitHub Releases through `github:owner/repo`, or exact checksum-pinned artifacts through `http:https://...{version}...` |
