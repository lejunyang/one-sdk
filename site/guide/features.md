...
| [容器运行时、Registry 与原生缓存](./containers) | Runtime/cache 诊断、匿名 OCI Registry 测试与只读原生 mirror plan |
...
- 检查 Docker、containerd、Buildx、OCI Registry、mirror plan 或原生缓存用量：参阅[容器运行时、Registry 与原生缓存](./containers)。
